...
function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800 sm:text-5xl">
        About R Estate
      </h1>
      <p className="mb-4 sm:text-xl text-slate-700">
        R Estate is a leading real estate agency that specializes in
